...
class Chatbot {
    ...
    async shouldWake(message) {
        ...
        if (wakewords) {
            const allWords = wakewords.split(',');
            ...
            if (word === 'commands') {
                return this.sendMessage('commands');
            }
            ...
            return allWords.includes(word) ? cmd : false;
        }
    ...
    async startSearch(message) {
        ...
        switch (type) {
            ...
            default:
                await this.sendMessage('unknownType', [type]);
                break;
        }
    }
    ...
    async addResult(id) {
        ...
        try {
            ...
            return this.sendMessage('rowNotFound');
        }
