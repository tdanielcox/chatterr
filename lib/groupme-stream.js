...
var Constants       = {
    "DEBUG" : false,
    "WEBSOCKETS_BASEURL": "https://push.groupme.com/faye",
    "API_BASEURL":"https://api.groupme.com/v3",
    "IMAGESERVICE_BASEURL": "image.groupme.com",
    "IMAGESERVICE_UPLOADPATH": "/upload",
};
...
*/
function GroupMeStream(access_token, userid, groupids) {
...
util.inherits(GroupMeStream, events.EventEmitter);

/************************************************************************
 * Externally-used API
 ***********************************************************************/

GroupMeStream.prototype.connect = function() {
    this.client.connect(Constants.WEBSOCKETS_BASEURL);
};

GroupMeStream.prototype.disconnect = function() {
    if (this.connection)
...
GroupMeStream.prototype.handleError = function(str, payload) {
    self.emit('error', str, payload);
}
GroupMeStream.prototype.setState = function(state) {
    this.state = state;
    this.emit(state);
}
GroupMeStream.prototype.handshake = function() {
    var data = {
...
GroupMeStream.prototype.handshakeResponse = function(data) {
    if (data["successful"]) {
...
GroupMeStream.prototype.subscribeUser = function() {
    var data = {
...
GroupMeStream.prototype.subscribeResponse = function(data) {
    if (data["successful"]) {
        this.startListening();
...
GroupMeStream.prototype.subscribeGroups = function() {
    var self = this;
...
GroupMeStream.prototype.startListening = function() {
    var data = {
...
GroupMeStream.prototype.send = function(data) {
    var self = this;
